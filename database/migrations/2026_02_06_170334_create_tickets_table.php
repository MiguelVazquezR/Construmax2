...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('tickets', function (Blueprint $table) {
            ...
            $table->string('report_number')->nullable()->comment('Número de reporte / número de ticket del cliente');
            ...
            $table->json('assistant_technicians')->nullable();
            ...
            $table->string('important_note', 500)->nullable();
            $table->boolean('has_oc')->default(false);
