...
<template>
    <div class="h-full flex flex-col bg-white dark:bg-[#1e1e20] border-r border-gray-100 dark:border-[#2b2b2e]">
        ...
        <div class="h-16 flex items-center justify-center border-b border-gray-100 dark:border-[#2b2b2e]">
            <Link :href="route('dashboard')" class="flex items-center gap-2">
                ...
                <span v-if="!isCollapse" class="font-bold text-lg tracking-tight text-gray-800 dark:text-white transition-opacity duration-300">
                    ERP<span class="text-primary">System</span>
                </span>
            </Link>
        </div>
            ...
            >
                ...
                <el-sub-menu index="crm">
                    ...
                    <Link :href="route('crm.dashboard')">
                        <el-menu-item index="crm-analytics">Analíticas</el-menu-item>
                    </Link>
                    <Link :href="route('customers.index')">
                        <el-menu-item index="crm-clients">Clientes</el-menu-item>
                    </Link>
                    <Link :href="route('budgets.index')">
                        <el-menu-item index="crm-budgets">Presupuestos</el-menu-item>
                    </Link>
                </el-sub-menu>
                ...
                <el-sub-menu index="tickets">
                    <template #title>
                     ...
                     <Link :href="route('tickets.dashboard')">
                ...
                <el-sub-menu index="settings">
                    ...
                    <Link :href="route('users.index')">
                        <el-menu-item index="users.index">Usuarios</el-menu-item>
                    </Link>
                    <Link :href="route('config.roles-permissions.index')">
                        <el-menu-item index="roles-index">Roles y Permisos</el-menu-item>
                    </Link>
                </el-sub-menu>
