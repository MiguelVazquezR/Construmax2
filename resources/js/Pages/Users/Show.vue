...
<template>
    <AppLayout title="Detalles de usuario">
        ...
        <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
            <div
                class="bg-white dark:bg-[#1e1e20] shadow-sm rounded-lg overflow-hidden border border-gray-100 dark:border-[#2b2b2e]">

                <!-- Cabecera de Perfil -->
                <div
                    class="p-6 md:p-8 border-b border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row items-center sm:items-start gap-6">
                    ...
                    <div class="text-center sm:text-left flex-1">
                        ...
                        <div class="mt-2 flex flex-wrap gap-2 justify-center sm:justify-start">
                            ...
                            <span v-else class="text-xs text-gray-400 italic mt-1">Sin roles asignados</span>
                        </div>
